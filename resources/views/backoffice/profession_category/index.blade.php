    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <button type="button" onclick="window.location.href='{{ route('backoffice.master.profession-category.export') }}'" class="btn btn-primary me-3"><i class="align-middle" data-feather="file-text"></i> Export</button>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-row-bordered border align-middle rounded w-100" id="table_profession">

            ...
            <div class="modal-body">
                <form action="javascript:onSave(this)" method="post" id="form_company" name="form_company"
                    ...
                    <div class="form-label">
                        ...
                        <select id="company_type" required name="company_type" class="form-control mb-3 col-12" style="width: 100%">
                    ...
                    <div class="form-label">
                        ...
                        <select id="scope" required name="scope" class="form-control mb-3 col-12" style="width: 100%">

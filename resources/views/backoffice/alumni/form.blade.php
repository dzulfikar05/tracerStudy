                ...
                <form action="javascript:onSave(this)" method="post" id="form_alumni" name="form_alumni" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="form-label col-md-6">
                            ...
                            <input id="nim" name="nim" class="form-control mb-3" type="text" max="10" required placeholder="NIM">
                        </div>

                        <div class="form-label col-md-6">
                            <label class="mb-2 required col-12" for="study_program">Program Studi</label>
                            <select name="study_program" id="study_program" class="form-control mb-3" style="width: 100%" required>
                        ...
                        <div class="form-label col-md-6">
                            ...
                            <input id="phone" name="phone" class="form-control mb-3" type="text" placeholder="Nomor Telepon">
                        </div>
                        ...
                        <div class="form-label col-md-6">
                            ...
                            <input id="start_work_now_date" name="start_work_now_date" class="form-control mb-3" type="date">
                        </div>
                        <div class="form-label col-md-6">
                            <label class="mb-2 col-12" for="profession_category_id">Kategori Profesi</label>
                            <select id="profession_category_id" name="profession_category_id" class="form-control mb-3" style="width: 100%">
                                <option value="">- Pilih Kategori Profesi -</option>
                            </select>
                        </div>
                        <div class="form-label col-md-6">
                            <label class="mb-2 col-12" for="profession_id">Profesi</label>
                            <select id="profession_id" name="profession_id" class="form-control mb-3" style="width: 100%">
                        ...
                        <div class="form-label col-md-6">
                            ...
                            <select id="superior_id" name="superior_id" class="form-control mb-3" style="width: 100%">

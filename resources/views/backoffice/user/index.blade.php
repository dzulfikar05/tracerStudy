        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group d-flex justify-content-end mb-3">
                    <button type="button" onclick="window.location.href='{{ route('backoffice.master.user.export') }}'"
                        class="btn btn-primary me-3"><i class="align-middle fa fa-file-text" data-feather="file-text"></i> Export</button>
